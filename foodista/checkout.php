	...
	header('location:login.php');
                                                ...
                                                if ($_POST['submit']) {
                                                    ...
                                                    if ($payment_mode === 'COD') {
                                                        ...
                                                        function_alert(); // Shows alert and redirects to your_orders.php
                                                    }
                                                
                                                    if ($payment_mode === 'razorpay') {
                                                        $_SESSION['grand_total'] = $item_total;
                                                        $_SESSION['pay_amount'] = $item_total; // ✅ This line fixes the issue
                                                    
                                                        echo "<script>window.location.href = 'razorpay_redirect.php';</script>";
                                                        exit();
                                                    }
                                                }
                                            }
...
<head>
    ...
    <link rel="icon" href="#">
    <title>Checkout || Online Food Ordering System - FOODISTA</title>
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/Logo.png" alt="" width="28%"> </a>
                                            ...
                                            <ul class=" list-unstyled">
                                                ...
                                                <li>
                                                    <label class="custom-control custom-radio  m-b-10">
                                                        <input name="mod" type="radio" value="razorpay"  class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Pay with Razorpay</span> </label>
                                                </li>
                                            </ul>
